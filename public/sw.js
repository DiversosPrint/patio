const CACHE_NAME = 'patio-diversos-print-v2-diario';
const STATIC_ASSETS = ['/', '/index.html', '/styles.css', '/app.js', '/manifest.json', '/images/logo-print.png', '/images/icon-192.png', '/images/icon-512.png', '/images/tela-login.png'];
